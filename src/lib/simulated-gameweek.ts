...
export const simulatedTeams: [SimulatedTeam, SimulatedTeam] = [
  {
    ...
    players: [
      ...
      { id: 7, name: "Lamine Yamal", club: "Barcelona", stats: { position: "MID", minutes: 90, goals: 1, assists: 1, shotsOnTarget: 3, completedPasses: 42, manOfTheMatch: true, captain: true } },
      { id: 8, name: "Florian Wirtz", club: "Bayer Leverkusen", stats: { position: "MID", minutes: 71, shotsOnTarget: 1, completedPasses: 39, bigChancesMissed: 1 } },
      { id: 9, name: "Erling Haaland", club: "Manchester City", stats: { position: "FWD", minutes: 90, goals: 2, shotsOnTarget: 4, bigChancesMissed: 1, completedPasses: 18 } },
  ...
  },
  {
    ...
    players: [
      ...
      { id: 108, name: "Rafael Leão", club: "Milan", stats: { position: "MID", minutes: 65, shotsOnTarget: 2, bigChancesMissed: 1, completedPasses: 22 } },
      { id: 109, name: "Mohamed Salah", club: "Liverpool", stats: { position: "FWD", minutes: 90, goals: 1, assists: 1, shotsOnTarget: 3, completedPasses: 29, manOfTheMatch: true, captain: true } },
