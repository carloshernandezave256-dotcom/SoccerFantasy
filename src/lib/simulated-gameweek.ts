...
export const simulatedTeams: [SimulatedTeam, SimulatedTeam] = [
  {
    ...
    players: [
      ...
      { id: 7, name: "Lamine Yamal", club: "Barcelona", stats: { position: "MID", minutes: 90, goals: 1, assists: 1, shotsOnTarget: 3, completedPasses: 42, captain: true } },
  ...
  },
  {
    ...
    players: [
      ...
      { id: 109, name: "Mohamed Salah", club: "Liverpool", stats: { position: "FWD", minutes: 90, goals: 1, assists: 1, shotsOnTarget: 3, completedPasses: 29, captain: true } },
