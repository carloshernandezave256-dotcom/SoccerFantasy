...
export default function LoginPage() {
  ...
  async function submit(event: FormEvent) {
    ...
    if (result.data.session) router.push(invite ? `/league?invite=${encodeURIComponent(invite)}` : "/league"); else setMessage(invite ? "Check your email to confirm your account, then reopen the invite link and log in." : "Check your email to confirm your account, then log in.");
  }
