...
type Player={id:number;full_name:string;position:string;club:string;photo_url?:string|null;captain?:boolean;score:number;status:"not_started"|"live"|"final";ledger:LedgerEntry[]};
