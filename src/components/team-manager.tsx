...
export function TeamManager(){
  ...
  const loadRoster=useCallback(async(id:string,ownerId:string)=>{
    ...
    setEditing(loadedRoster.length>=11&&(!savedLineupIsValid||savedCaptain===null));setDirty(false);setCaptainMode(false);setSelectedBench(null);setLoading(false);
  },[]);
