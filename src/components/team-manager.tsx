...
export function TeamManager(){
  ...
  function reorderStarter(id:number,targetId:number){
    ...
    if(isMine&&captain!==null&&valid)void persistOrder(next,previous);
  }
