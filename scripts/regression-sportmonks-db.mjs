...
try{
 ...
 create table players(id bigint primary key,full_name text,club text,competition text,position player_position,photo_url text);
 ...
 insert into players values(1,'Alpha Player','Home','Premier League','MID',null),(2,'Duplicate','Home','Premier League','DEF',null),(3,'Duplicate','Home','Premier League','FWD',null);
