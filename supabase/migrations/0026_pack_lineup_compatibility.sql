...
revoke all on function public.save_lineup(uuid,bigint[],bigint[],bigint) from public,anon;grant execute on function public.save_lineup(uuid,bigint[],bigint[],bigint) to authenticated;
